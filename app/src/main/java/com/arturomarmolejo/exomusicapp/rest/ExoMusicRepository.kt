...
class ExoMusicRepositoryImpl @Inject constructor(
    ...
    override fun getTracksByGenre(searchTerm: String): Flow<UIState<TrackListResponse>> = flow {
        emit(UIState.LOADING)
        try{
            val response = exoMusicApi.getTrackListByGenre(searchTerm, "music", "song", "50")
